...
(function () {
  ...
  var MEAS = [
    ...
    { a: 'kom', tags: ['Schatten', 'Feuer'],
      t: { de: 'Waldbrandriegel nach amtlicher Empfehlung 40–50 m breit — als wirksam gilt bislang nur die Rot-Eiche; entscheidend ist ohnehin die Struktur, nicht die Baumart.',
           en: 'Firebreak strips 40–50 m wide as officially recommended — only red oak is so far rated effective, and structure matters more than species anyway.' } },
    { a: 'kom', tags: ['Wind', 'Tau'],
