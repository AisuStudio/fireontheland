...
(function () {
  ...
  var T = {
    de: {
      ...
      'nbr.summary': 'Was misst dieses Bild eigentlich? NBR kurz erklärt',
      'nbr.body': 'Satelliten wie Sentinel-2 messen nicht nur sichtbares Licht, sondern auch Infrarot, das das Auge nicht sieht. Vitale Pflanzen werfen das <strong>nahe Infrarot</strong> stark zurück; frisch verbrannte, verkohlte Flächen reflektieren stattdessen vor allem das <strong>kurzwellige Infrarot</strong>. Der NBR (<em>Normalized Burn Ratio</em>, sinngemäß: Brandschaden-Messwert) verrechnet beide zu einer Zahl je Bildpunkt — hohe Werte heißen vitale Vegetation, tiefe Werte verbrannt oder kahl. Das Komposit oben legt diesen Messwert aus drei Jahren auf die Farbkanäle Rot, Grün und Blau: Deshalb erzählt die Farbe jedes Pixels, <em>wann</em> es sich erholt hat.',
      'nbr.body2': 'Zwei Verwandte, die einem dabei begegnen: <strong>dNBR</strong> ist die Vorher-nachher-Differenz des NBR — je größer, desto schwerer der Brandschaden; der Standard, um Brandflächen abzugrenzen und ihre Schwere zu kartieren. Und der bekanntere <strong>NDVI</strong> (sinngemäß: Grünheits-Messwert) vergleicht rotes mit nahem Infrarotlicht und misst, wie viel vitales Grün da ist. Für Brandflächen ist der NBR das schärfere Werkzeug, weil das kurzwellige Infrarot direkt auf Verkohlung und offenen Boden anspricht, wo der NDVI nur „weniger grün" sieht.',
      ...
      'crit.Kohlenstoff': 'Kohlenstoff speichern',
      'clvl.hoch': 'hoch',
      'clvl.mittel': 'mittel',
      'clvl.gering': 'gering',
      'species.carbonNote': 'Die Kohlenstoff-Einstufung ist qualitativ — Wuchsform, Holzdichte, Lebensdauer —, keine gemessenen Tonnen pro Hektar. Und Speicher ist nur, was stehen bleibt: Was der nächste Brand nimmt, war Zwischenlager (s. Scorecard).',
      ...
      'albedo.summary': 'Was der Kohlenstoff nicht zeigt: die Albedo',
      'albedo.body': 'Neben dem Kohlenstoff hat jede Fläche eine zweite Klimastellschraube: die <strong>Albedo</strong> — den Anteil des Sonnenlichts, den sie zurückwirft. Ein Brand macht die Fläche schlagartig dunkler: Die verkohlte Oberfläche schluckt mehr Sonnenenergie und heizt sich lokal auf; mit der Erholung wird sie wieder heller. Darin steckt ein unbequemer Zielkonflikt der Wiederbewaldung: Dunkler Nadelwald (Albedo grob 0,08–0,12) absorbiert deutlich mehr Sonnenlicht als helle Gras- und Sandflächen (grob 0,15–0,25). Ein Teil der CO₂-Kühlwirkung einer Aufforstung wird dadurch wieder aufgezehrt — die helle Sandheide „kühlt" strahlungsseitig, bindet aber kaum Kohlenstoff; der dunkle Forst bindet Kohlenstoff, schluckt dafür mehr Sonne.',
      'albedo.body2': 'Zur Größenordnung: Ein Albedo-Unterschied von 0,1 bedeutet bei brandenburgischer Einstrahlung (rund 125&nbsp;W/m² im Jahresmittel) etwa 12&nbsp;W/m² zusätzlich absorbierte Leistung — lokal an der Oberfläche; wie viel davon im Klimasystem ankommt, hängt von Wolken und Atmosphäre ab. Für diese Fläche ist das eine Einordnung aus der Literatur, keine Messung (grundlegend Betts 2000, <em>Nature</em>, zur borealen Aufforstung; Rohatyn u.&nbsp;a. 2022, <em>Science</em>, zu trockenen Standorten). Perspektivisch ließen sich die NBR-Kacheln oben um eine Albedo-Ebene aus denselben Sentinel-2-Daten ergänzen — dann zeigte die Karte beides: wie grün die Fläche wird und wie hell sie bleibt.',
      ...
      'carbon.after': '3 Jahre nach dem Brand',
      'carbon.valAfter': 'höchstens 1,4 t C/ha',
      'carbon.before': 'Gewachsener Kiefernforst',
      'carbon.valBefore': 'rund 85 t C/ha',
      'carbon.note': 'Umgerechnet mit einem Kohlenstoffanteil von 50&nbsp;% der Trockenmasse. Selbst im günstigsten Fall steht drei Jahre nach dem Brand also <strong>unter zwei Prozent</strong> dessen, was ein gewachsener Kiefernbestand bindet — in Jüterbog an Standort&nbsp;U praktisch nichts. Das beziffert den <em>Verlust</em>, nicht die Wirksamkeit der drei Strategien: Welcher Weg am schnellsten wieder Kohlenstoff aufbaut, ließe sich erst mit Ertragstafeln oder einer Wuchssimulation sagen. Und Speicher ist nur, was stehen bleibt — was der nächste Brand nimmt, war Zwischenlager.',
      'scenarios.sourceTitle': 'Quellen',
    ...
    en: {
      ...
      'nbr.summary': 'What does this image actually measure? NBR in brief',
      'nbr.body': 'Satellites like Sentinel-2 measure not just visible light but also infrared the eye can’t see. Healthy plants reflect <strong>near-infrared</strong> strongly; freshly burned, charred ground instead reflects mostly <strong>shortwave infrared</strong>. The NBR (<em>Normalized Burn Ratio</em> — think of it as a burn-severity reading) combines the two into one number per pixel: high values mean living vegetation, low values mean burned or bare. The composite above maps that reading from three years onto the red, green and blue colour channels — which is why the colour of each pixel tells you <em>when</em> it recovered.',
      'nbr.body2': 'Two relatives you’ll run into: <strong>dNBR</strong> is the before-and-after difference of the NBR — the bigger it is, the heavier the burn damage; it’s the standard for outlining burn scars and mapping their severity. And the better-known <strong>NDVI</strong> (a greenness reading) compares red with near-infrared light to measure how much living green there is. For burn scars the NBR is the sharper tool, because shortwave infrared responds directly to char and bare soil where the NDVI only sees “less green”.',
      ...
      'crit.Kohlenstoff': 'Store carbon',
      'clvl.hoch': 'high',
      'clvl.mittel': 'medium',
      'clvl.gering': 'low',
      'species.carbonNote': 'The carbon rating is qualitative — growth form, wood density, lifespan — not measured tonnes per hectare. And storage only counts while it stands: what the next fire takes was interim storage (see Scorecard).',
      ...
      'albedo.summary': 'What the carbon doesn\u2019t show: albedo',
      'albedo.body': 'Besides carbon, every site has a second climate lever: its <strong>albedo</strong> \u2014 the share of sunlight it reflects. A fire darkens the site abruptly: the charred surface absorbs more solar energy and heats up locally; as recovery proceeds, it brightens again. And here sits an uncomfortable trade-off for reforestation: dark conifer forest (albedo roughly 0.08\u20130.12) absorbs considerably more sunlight than bright grass and sand (roughly 0.15\u20130.25). Part of the CO\u2082 cooling benefit of afforestation is eaten back up \u2014 the bright sand heath \u201ccools\u201d radiatively but stores hardly any carbon; the dark forest stores carbon but swallows more sun.',
      'albedo.body2': 'For scale: an albedo difference of 0.1 means, at Brandenburg\u2019s insolation (around 125&nbsp;W/m\u00b2 annual mean), roughly 12&nbsp;W/m\u00b2 of additionally absorbed power \u2014 locally, at the surface; how much of that reaches the climate system depends on clouds and atmosphere. For this site that is a framing from the literature, not a measurement (foundational: Betts 2000, <em>Nature</em>, on boreal afforestation; Rohatyn et&nbsp;al. 2022, <em>Science</em>, on dryland sites). Down the line, the NBR tiles above could gain an albedo layer from the same Sentinel-2 data \u2014 the map would then show both: how green the site becomes and how bright it stays.',
      ...
      'carbon.after': '3 years after the fire',
      'carbon.valAfter': 'at most 1.4 t C/ha',
      'carbon.before': 'Established pine forest',
      'carbon.valBefore': 'about 85 t C/ha',
      'carbon.note': 'Converted at a carbon fraction of 50&nbsp;% of dry mass. Even in the best case, three years after the fire the site holds <strong>under two per cent</strong> of what an established pine stand binds — on Jüterbog plot&nbsp;U effectively nothing. This quantifies the <em>loss</em>, not the effectiveness of the three strategies: which route rebuilds carbon fastest would need yield tables or a growth simulation to answer. And storage is only what stays standing — whatever the next fire takes was a way-station.',
      'scenarios.sourceTitle': 'Sources',
  ...
  var AXES = [
    ...
    { v: 'neo',
      ...
      pine: { de: 'Wurzelt so tief, wie der Boden es zulässt — auf tiefem Sand wie hier per Pfahlwurzel, und trotzdem zunehmend trocken- und hitzegestresst.',
              en: 'Roots as deep as the soil allows — a taproot on deep sand like here, yet increasingly drought- and heat-stressed.' },
    ...
    { v: 'split',
      axis: { de: 'Strahlungshaushalt (Albedo)', en: 'Radiation balance (albedo)' },
      pine: { de: 'Dunkle Nadelkronen das ganze Jahr: niedrigste Albedo, mehr absorbierte Sonnenenergie — ein Teil des CO₂-Nutzens wird strahlungsseitig wieder aufgezehrt. Schatten und Verdunstung kühlen dafür vor Ort.',
              en: 'Dark conifer canopy all year: lowest albedo, more absorbed solar energy — part of the CO₂ benefit is eaten back up radiatively. Shade and transpiration do cool the site itself.' },
      neo: { de: 'Laub- und Pionierstadien sind heller, Gras und offener Sand am hellsten — strahlungsseitig ein Plus, das mit jedem Kronenschluss schrumpft. Und Helligkeit bindet keinen Kohlenstoff.',
             en: 'Broadleaf and pioneer stages are brighter, grass and open sand brightest — a radiative plus that shrinks with every closing canopy. And brightness stores no carbon.' } },
    { v: 'pine',
  ...
  var SPECIES = [
    ...
    { id: 'zitterpappel', name: { de: 'Zitterpappel', en: 'Aspen' }, latin: 'Populus tremula',
      ...
      c: { lvl: 'mittel', de: 'schnellste Biomasse hier, aber kurzlebig, weiches Holz', en: 'fastest biomass here, but short-lived, soft wood' },
    ...
    { id: 'sandbirke', name: { de: 'Sandbirke', en: 'Silver birch' }, latin: 'Betula pendula',
      ...
      c: { lvl: 'mittel', de: 'schnell, aber kurzlebig, weiches Holz', en: 'fast but short-lived, soft wood' },
    ...
    { id: 'waldkiefer', name: { de: 'Waldkiefer', en: 'Scots pine' }, latin: 'Pinus sylvestris',
      origin: 'native', tags: ['Trockenheit', 'Sandboden', 'Pionier', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'viel Stammholz, aber brandfragil', en: 'high stem volume, but fire-fragile' },
    ...
    { id: 'salweide', name: { de: 'Salweide', en: 'Goat willow' }, latin: 'Salix caprea',
      ...
      c: { lvl: 'mittel', de: 'kleiner, kurzlebiger Baum', en: 'small, short-lived tree' },
    ...
    { id: 'traubeneiche', name: { de: 'Traubeneiche', en: 'Sessile oak' }, latin: 'Quercus petraea',
      origin: 'native', tags: ['Trockenheit', 'Sandboden', 'Wiederaustrieb', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'dichtes, langlebiges Holz', en: 'dense, long-lived wood' },
    ...
    { id: 'besenheide', name: { de: 'Besenheide', en: 'Heather' }, latin: 'Calluna vulgaris',
      ...
      c: { lvl: 'gering', de: 'Zwergstrauch, kaum Holzkörper', en: 'dwarf shrub, hardly any wood' },
    ...
    { id: 'silbergras', name: { de: 'Silbergras', en: 'Grey hair-grass' }, latin: 'Corynephorus canescens',
      ...
      c: { lvl: 'gering', de: 'Gras: Umsatz statt Speicher', en: 'grass: turnover, not storage' },
    ...
    { id: 'sandsegge', name: { de: 'Sand-Segge', en: 'Sand sedge' }, latin: 'Carex arenaria',
      ...
      c: { lvl: 'gering', de: 'Umsatz statt Speicher, Wurzel-C in den Boden', en: 'turnover, root carbon into the soil' },
    ...
    { id: 'adlerfarn', name: { de: 'Adlerfarn', en: 'Bracken' }, latin: 'Pteridium aquilinum',
      ...
      c: { lvl: 'gering', de: 'oberirdisch wenig, Rhizom-C im Boden', en: 'little aboveground, rhizome carbon in the soil' },
    ...
    { id: 'weidenroeschen', name: { de: 'Schmalblättriges Weidenröschen', en: 'Rosebay willowherb' }, latin: 'Chamaenerion angustifolium',
      origin: 'native', tags: ['Pionier', 'Bestaeuber'],
      c: { lvl: 'gering', de: 'krautig, schneller Umsatz', en: 'herbaceous, fast turnover' },
    ...
    { id: 'besenginster', name: { de: 'Besenginster', en: 'Common broom' }, latin: 'Cytisus scoparius',
      ...
      c: { lvl: 'gering', de: 'kurzlebiger Strauch', en: 'short-lived shrub' },
    ...
    { id: 'brombeere', name: { de: 'Brombeere', en: 'Bramble' }, latin: 'Rubus fruticosus agg.',
      origin: 'native', tags: ['Pionier', 'Bestaeuber', 'Wiederaustrieb'],
      c: { lvl: 'gering', de: 'Dickicht mit schnellem Umsatz, kaum Holz', en: 'thicket with fast turnover, hardly any wood' },
      t: { de: 'Vogelverbreiteter Dornstrauch der Lichtungen und Brandflächen, treibt aus dem Wurzelstock immer wieder aus. Wochenlange Blüte und Beeren machen sie zu einer der wertvollsten Insekten- und Vogelpflanzen der Sukzession — und ihre Dickichte sind eine [[ammenstruktur|Ammenstruktur]] zum Nulltarif: Dornschutz, durch den junge Eichen dem Verbiss entwachsen. Auf dem nährstoffärmsten Reinsand bleibt sie fleckig; auf Schutz-Offenland zählt sie zur Verbuschung.',
           en: 'Bird-dispersed thorn shrub of clearings and burn scars, resprouting again and again from the rootstock. Weeks of flowering and berries make it one of succession’s most valuable insect and bird plants — and its thickets are a free [[ammenstruktur|nurse structure]]: thorn cover through which young oaks outgrow browsing. On the poorest bare sand it stays patchy; on protected open habitat it counts as scrub encroachment.' } },
    { id: 'wacholder', name: { de: 'Wacholder', en: 'Common juniper' }, latin: 'Juniperus communis',
      origin: 'native', tags: ['Trockenheit', 'Sandboden', 'Wind'],
      c: { lvl: 'gering', de: 'langlebig, aber klein und extrem langsam', en: 'long-lived but small and extremely slow' },
    ...
    { id: 'sanddorn', name: { de: 'Sanddorn', en: 'Sea buckthorn' }, latin: 'Hippophae rhamnoides',
      ...
      c: { lvl: 'gering', de: 'Strauch, wenig Holzkörper', en: 'shrub, little woody mass' },
    ...
    { id: 'robinie', name: { de: 'Robinie', en: 'Black locust' }, latin: 'Robinia pseudoacacia',
      origin: 'neo', tags: ['Stickstoff', 'Trockenheit', 'Sandboden', 'Bestaeuber', 'Wiederaustrieb', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'dicht und dauerhaft — solange kein Brand', en: 'dense and durable — as long as it doesn’t burn' },
    ...
    { id: 'roteiche', name: { de: 'Rot-Eiche', en: 'Red oak' }, latin: 'Quercus rubra',
      origin: 'neo', tags: ['Trockenheit', 'Sandboden', 'Wiederaustrieb', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'dichtes, langlebiges Holz', en: 'dense, long-lived wood' },
    ...
    { id: 'traubenkirsche', name: { de: 'Spätblühende Traubenkirsche', en: 'Black cherry' }, latin: 'Prunus serotina',
      ...
      c: { lvl: 'mittel', de: 'oft strauchig, weiches Holz', en: 'often shrubby, soft wood' },
    ...
    { id: 'essigbaum', name: { de: 'Essigbaum', en: 'Staghorn sumac' }, latin: 'Rhus typhina',
      ...
      c: { lvl: 'gering', de: 'klein, kurzlebig', en: 'small, short-lived' },
    ...
    { id: 'flieder', name: { de: 'Gemeiner Flieder', en: 'Common lilac' }, latin: 'Syringa vulgaris',
      origin: 'neo', tags: ['Trockenheit', 'Sandboden', 'Wiederaustrieb'],
      c: { lvl: 'gering', de: 'Strauch, wenig Holzkörper', en: 'shrub, little woody mass' },
      t: { de: 'Gartenflüchtling aus Südosteuropa, seit dem 16. Jahrhundert kultiviert. Auf ehemaligen Truppenübungsplätzen markieren verwilderte Fliederbüsche oft die Stellen verschwundener Dörfer und Gehöfte — Kulturspuren, die Sand, Hitze und Jahrzehnte überdauern, weil der Strauch aus Wurzelausläufern immer neu austreibt. Für Bienen gibt die enge Blütenröhre wenig her; der Duft verspricht mehr, als erreichbar ist.',
           en: 'A garden escape from southeastern Europe, cultivated since the 16th century. On former military training grounds, feral lilac bushes often mark the sites of vanished villages and farmsteads — cultural traces that outlast sand, heat and decades because the shrub keeps resprouting from root suckers. For bees its narrow flower tube offers little; the scent promises more than is reachable.' } },
    { id: 'schwarzkiefer', name: { de: 'Schwarzkiefer', en: 'Austrian pine' }, latin: 'Pinus nigra',
      origin: 'neo', tags: ['Trockenheit', 'Sandboden', 'Pionier', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'viel Stammholz, aber brandfragil', en: 'high stem volume, but fire-fragile' },
    ...
    { id: 'douglasie', name: { de: 'Douglasie', en: 'Douglas fir' }, latin: 'Pseudotsuga menziesii',
      origin: 'neo', tags: ['Trockenheit', 'Sandboden', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'großes Volumen, langlebig', en: 'large volume, long-lived' },
    ...
    { id: 'baumhasel', name: { de: 'Baumhasel', en: 'Turkish hazel' }, latin: 'Corylus colurna',
      origin: 'neo', tags: ['Trockenheit', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'langlebig, hartes Holz', en: 'long-lived, hard wood' },
    ...
    { id: 'edelkastanie', name: { de: 'Edelkastanie', en: 'Sweet chestnut' }, latin: 'Castanea sativa',
      origin: 'archaeo', tags: ['Sandboden', 'Bestaeuber', 'Kohlenstoff'],
      c: { lvl: 'hoch', de: 'langlebig, dauerhaftes Holz', en: 'long-lived, durable wood' },
  ...
  var IMG_CREDITS = {
    ...
    brombeere: { a: 'Sven Teschke', l: 'CC BY-SA 3.0 de', u: 'https://creativecommons.org/licenses/by-sa/3.0/de/deed.en', s: 'https://commons.wikimedia.org/wiki/File:Brombeere_0815-23.jpg' },
    ...
    flieder: { a: 'Magnus Manske', l: 'CC BY 1.0', u: 'https://creativecommons.org/licenses/by/1.0', s: 'https://commons.wikimedia.org/wiki/File:Lilac_(2).jpg' },
  ...
  var CRITERIA = ['Wiederaustrieb', 'Pionier', 'Stickstoff', 'Bestaeuber', 'Wind', 'Kohlenstoff'];
  ...
  function buildSpCard(sp) {
    ...
    li.innerHTML = figure +
      ...
      '<p></p>' +
      '<p class="sp-carbon"><strong></strong> <span></span></p>' +
    ...
    var cEl = li.querySelector('.sp-carbon');
    if (sp.c) {
      cEl.querySelector('strong').textContent = t('tag.Kohlenstoff') + ':';
      cEl.querySelector('span').textContent = t('clvl.' + sp.c.lvl) + ' — ' + pick(sp.c);
    } else {
