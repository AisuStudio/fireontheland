...
(function () {
  ...
  var SPECIES = [
    ...
    { id: 'adlerfarn', name: { de: 'Adlerfarn', en: 'Bracken' }, latin: 'Pteridium aquilinum',
      origin: 'native', tags: ['Pionier', 'Trockenheit', 'Sandboden'],
      t: { de: 'Lehrbuch-Erstbesiedler brandenburgischer Brandflächen — tiefes Rhizom übersteht das Feuer, breitet sich auf Sand rasant aus.',
           en: 'A textbook first colonist of Brandenburg burn scars — its deep rhizome survives the fire and spreads rapidly across sand.' } },
    ...
    { id: 'waldkiefer', name: { de: 'Waldkiefer', en: 'Scots pine' }, latin: 'Pinus sylvestris',
      ...
      t: { de: 'Die namensgebende Kulturkiefer Brandenburgs selbst — Pionier auf reinstem Sand, aber harzreich und im Reinbestand genau die brandanfällige Monokultur, die Noveco hinterfragt.',
           en: 'Brandenburg’s namesake cultivated pine itself — a pioneer on the purest sand, but resin-rich, and in monoculture exactly the fire-prone stand Noveco questions.' } },
    { id: 'haselnuss', name: { de: 'Haselnuss', en: 'Common hazel' }, latin: 'Corylus avellana',
      origin: 'native', tags: ['Pionier', 'Bestaeuber'],
      t: { de: 'Heimischer Pionierstrauch mit den frühesten Kätzchen des Jahres — wichtige Pollenquelle im Vorfrühling, bevorzugt aber tieferen Boden als reinen Sand.',
           en: 'Native pioneer shrub with the year’s earliest catkins — a key early-spring pollen source, though it prefers deeper soil rather than pure sand.' } },
    ...
    { id: 'douglasie', name: { de: 'Douglasie', en: 'Douglas fir' }, latin: 'Pseudotsuga menziesii',
      origin: 'neo', tags: ['Trockenheit', 'Sandboden', 'Pionier'],
      t: { de: 'Nordamerikanischer Neophyt, oft als Ersatz für die klimasensible heimische Weißtanne getestet — deutlich trockenheitsfester, aber botanisch keine echte Tanne.',
           en: 'North American neophyte, often trialled as a substitute for the climate-sensitive native silver fir — markedly more drought-hardy, though botanically not a true fir.' } },
